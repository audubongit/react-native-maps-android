...
export declare const MarkerAnimated: import('react-native/types').Animated.AnimatedComponent<
  typeof import('./MapMarker').MapMarker
>;
export declare const OverlayAnimated: import('react-native/types').Animated.AnimatedComponent<
